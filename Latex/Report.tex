...
\begin{table}[H]
	...
	\begin{tabular}{lccccccc}
		...
		\midrule
		INV		& 50 ps & 55 ps & 40 ps & 40 ps &	128\(\lambda\) &	86\(\lambda\)	& 11,008\(\lambda\)	\\
		2NAND	& 135 ps & 120 ps &   120 ps &   90 ps  &	128\(\lambda\)	&	90\(\lambda\) 	& 11,520\(\lambda\)	\\
		3NAND	& 215 ps & 130 ps & 135 ps & 100 ps &	128\(\lambda\) &	94\(\lambda\) 	& 12,032\(\lambda\)	\\
		4NAND	& 265 ps & 155 ps & 185 ps & 110 ps &	128\(\lambda\)	&	98\(\lambda\) 	& 12,544\(\lambda\)	\\
		\bottomrule
	\end{tabular}
\end{table}
...
To accomplish this, first each segment was laid out 
