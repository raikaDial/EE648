...
During these simulations, the gate delay, rise, and fall times were also measured.
...
\begin{table}[H]
	...
	\begin{tabular}{lcccccc}
		\toprule
		Gate & Delay (ns) & Rise (ns) & Fall (ns) & Width (\(\lambda\)) & Height (\(\lambda\)) & Area (\(\lambda^2\))\\
		\midrule
		INV		& 0.12 & 0.23 & 0.25 &	128 &	86	& 11,008	\\
		2NAND	&&&&	128	&	90 	& 11,520	\\
		3NAND	&&&&	128 &	94 	& 12,032	\\
		4NAND	&&&&	128	&	98 	& 12,544	\\
		\bottomrule
